...
ALLOWED_HOSTS = ['subleasing-app-a03dfaf4b1ff.herokuapp.com', '127.0.0.1', 'localhost']
...
INSTALLED_APPS = [
    ...
    'listing_service.apps.ListingServiceConfig',  # listing_service app
...
ACCOUNT_EMAIL_REQUIRED = False  # Disable email requirement
...
ACCOUNT_EMAIL_VERIFICATION = "none"  # 이메일 인증 없이 바로 로그인 가능
ACCOUNT_LOGIN_METHODS = {"username"}
ACCOUNT_EMAIL_REQUIRED = False  # 이메일 필수 입력 해제

CSRF_TRUSTED_ORIGINS = [
    "https://subleasing-app-a03dfaf4b1ff.herokuapp.com",
]
...
if os.environ.get('DATABASE_URL'):
    # Use dj_database_url for Heroku or CI environments
